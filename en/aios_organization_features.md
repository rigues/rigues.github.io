...
*   **Greater privacy and lower bandwidth consumption**: only the metadata resulting from processing is sent to the platform, reducing the risk of exposure of sensitive data (images captured by your cameras) and bandwidth consumption compared to solutions that process in the cloud.
...
*   **Training module (Dojo)**: enables the development and training of customized AI models, perfectly adapted to your needs.
